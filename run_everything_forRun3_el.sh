dnnpath=~/github/anti_NanoAODRun3/DNN/DNN_0715_v9.1_syst0804/electron/
datacardPrefix=datacards_0715_v9.1_syst_el
#python3 prepareShapesAndCards.py -p ${dnnpath}/v12_2022_postprocess_2/ -o ${datacardPrefix}_2022 -xsecfile files_el.yml -dataYear 2022
#python3 prepareShapesAndCards.py -p ${dnnpath}/v12_2022EE_postprocess_2/ -o ${datacardPrefix}_2022EE -xsecfile files_el.yml -dataYear 2022EE
#python3 prepareShapesAndCards.py -p ${dnnpath}/v12_2023_postprocess_2/ -o ${datacardPrefix}_2023 -xsecfile files_el.yml -dataYear 2023
#python3 prepareShapesAndCards.py -p ${dnnpath}/v12_2023BPix_postprocess_2/ -o ${datacardPrefix}_2023BPix -xsecfile files_el.yml -dataYear 2023BPix
#python3 prepareShapesAndCards.py -p ${dnnpath}/v15_2024_postprocess_2/ -o ${datacardPrefix}_2024 -xsecfile files24_el.yml -dataYear 2024
#
